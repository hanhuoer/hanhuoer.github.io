        ...
        function (module, exports, __webpack_require__) {
            ...
            Symbol.prototype.getAttr = function (attName) {
                ...
                var line, x = this.getCenter().x, y = this.getCenter().y, right = this.getRight(),
                    bottom = this.getBottom(), left = this.getLeft(), symbolX = symbol.getCenter().x,
                    symbolY = symbol.getCenter().y, symbolTop = symbol.getTop(), symbolRight = symbol.getRight(),
                    symbolLeft = symbol.getLeft(), isOnSameColumn = x === symbolX, isOnSameLine = y === symbolY,
                    isUnder = symbolY > y, isUpper = y > symbolY || this === symbol, isLeft = x > symbolX,
                    isRight = symbolX > x, maxX = 0, lineLength = this.getAttr("line-length"),
      ...
      \********************************/
        ...
        function (module, exports, __webpack_require__) {
            function parse(input) {
                ...
                for (; lines.length > 0;) {
                    ...
                    if (line.indexOf("=>") >= 0) {
                        ...
                        var flowSymb = flowSymbols[i], realSymb = getSymbol(flowSymb), next = getNextPath(flowSymb),
                            direction = null;
                        if (next.indexOf(",") >= 0) {
            ...
            var FlowChart = __webpack_require__(/*! ./flowchart.chart */ 6),
                ...
                Operation = __webpack_require__(/*! ./flowchart.symbol.operation */ 11),
                InputOutput = __webpack_require__(/*! ./flowchart.symbol.inputoutput */ 10),
                Subroutine = __webpack_require__(/*! ./flowchart.symbol.subroutine */ 13),
      ...
      \********************************/
        ...
        function (module, exports, __webpack_require__) {
            ...
            var Raphael = __webpack_require__(/*! raphael */ 15),
                ...
                defaultOptions = __webpack_require__(/*! ./flowchart.defaults */ 7),
                Condition = __webpack_require__(/*! ./flowchart.symbol.condition */ 5);
